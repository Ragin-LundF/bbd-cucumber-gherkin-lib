Feature: Authorization with PUT tests
  Background:
    Given that all file paths are relative to "features/auth_and_methods/"


  Scenario: Unauthorized PUT call with direct API path and inner body should be rejected with a 401 error
    ...
    """
    When executing a PUT call to "/api/v1/unauthorized" with previously given body
  ...
  Scenario: Unauthorized PUT call with direct API path and file as body should be rejected with a 401 error
    When executing a PUT call to "/api/v1/unauthorized" with the body from file "requests/request.json"
    Then I ensure that the status code of the response is 401
    And I ensure that the body of the response is equal to
    """
    {
  ...
  Scenario: Unauthorized PUT call with previously given API path and previously given files as body should be rejected with a 401 error
  ...
  Scenario: Unauthorized PUT call with previously given API path and dynamic path elements is successful
  ...
  Scenario: Authorized PUT call with previously given API path and dynamic path elements from context is successful
  ...
  Scenario: Authorized PUT call with direct API path is successful
    Given that the file "requests/request.json" is used as the body
    When executing an authorized PUT call to "/api/v1/authorized" with previously given body
    Then I ensure that the status code of the response is 200
    And I ensure that the body of the response is equal to the file "responses/response_authorized.json"


  Scenario: Authorized PUT call with previously given API path is successful
  ...
  Scenario: Authorized PUT call with previously given API path and dynamic path elements is successful
    Given that the API path is "/api/v1/{apiPath}"
    And that the file "requests/request.json" is used as the body
